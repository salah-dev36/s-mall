...
import {createUserDocument, signInWithGooglePopup, signInAuthUser}from '../../utils/firebase/firebase-utils';
      ...
      resetFormFields();
        ...
        switch(err.code) {
          case 'auth/user-not-found' :
            alert('There was a problem, we cannot find an account with that email address');
            break;
